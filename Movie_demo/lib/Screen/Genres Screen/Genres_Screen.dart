...
import 'package:movie_demo/Screen/Genres%20Screen/GenresData_Screen.dart';
...
class _GenresScreenState extends State<GenresScreen> {
  ...
  Future<String> loadDataFromTMDB(int movieId) async {
    String api =
        'https://api.themoviedb.org/3/discover/movie?api_key=${KEY().apiKey}&with_genres=$movieId';
