...
import 'package:movie_demo/Screen/Player%20Screen/Widgets/Tv_showScreen.dart';
  ...
  Widget build(BuildContext context) {
    return CarouselSlider.builder(
      ...
      itemBuilder: (context, index, realIndex) {
        ...
        final String title =
            _trendingTvShows[index]['original_name'] ?? "Loading";
        final String moviedesp = _trendingTvShows[index]['overview'];
        final String releasedate =
            _trendingTvShows[index]['first_air_date'] ?? 'Loading';
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (contex) => TvShowVideosScreen(
                      imageUrl: img,
                      movieTitle: txt,
                      movieDesp: moviedesp,
